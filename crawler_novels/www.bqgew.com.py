...
ROOT_URL = "https://www.bqgew.com" # 网站根目录
GENERAL_PATH = "nov"                      # 通用路径
...
NOVEL_SUB_ID = "316/316345"              # 目录页面ID
ENCODING = "GBK"                    # 页面文字编码
CHAPTER_POST = 1
"https://www.bqgew.com/nov/316/316345/index.html"
if GENERAL_PATH == "":
...
def rtn_chapter_list_info(html):
    ...
    for ddItem in chapterListInfoSoup:
        ...
        chapterListInfoDict["text"] = ddItem.a.text.replace("增 ", "").replace("改 ", "").replace("新 ", "")
