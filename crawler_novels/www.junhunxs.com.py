...
ROOT_URL = "http://www.junhunxs.com" # 网站根目录
GENERAL_PATH = ""                      # 通用路径
NOVEL_SUB_ID = "aidaonongshi"              # 目录页面ID
ENCODING = "utf-8"                    # 页面文字编码
CHAPTER_POST = 1
"http://www.junhunxs.com/aidaonongshi/"
if GENERAL_PATH == "":
...
def rtn_chapter_list_info(html):
    ...
    chapterListInfoSoup = soup.find_all(name="div", attrs={"class": "book-list"})[0].find_all(name="li")
...
if __name__ == '__main__':
    ...
    html = get_html_all_content(FULL_URL, "book-describe", ENCODING)
    ...
    for chapterInfo in chapterListInfo:
        ...
        chapterHtml = get_html_all_content(chapterUrl, "m-article-text", ENCODING)
