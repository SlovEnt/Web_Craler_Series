...
ROOT_URL = "https://www.vodtw.com" # 网站根目录
GENERAL_PATH = "Html/Book"           # 通用路径
NOVEL_SUB_ID = "53/53105"          # 目录页面ID
ENCODING = "GB2312"                    # 页面文字编码
CHAPTER_POST = 1
"https://www.vodtw.com/Html/Book/53/53105/Index.html"
if GENERAL_PATH == "":
...
def rtn_chapter_list_info(html):
    ...
    novelName = soup.find_all(name="div", attrs={"class": "bookname"})[0].h1.text
    ...
    chapterListInfoSoup = soup.find_all(name="div" , attrs={"class": "insert_list"})[0].find_all(name="li")
...
def rtn_chapter_txt(chapterHtml):
    ...
    # print("---------------chapterHtml-----------------\n",chapterHtml,"\n\n\n\n")
    chapterHtml = chapterHtml.replace('<font color="#FF0000">手机阅读</font></a></b><br>', "")
    ...
    try:
        ...
        txtContent = txtContent.replace("品书网手机端 m.vodtW.com", "")
...
if __name__ == '__main__':
    ...
    html = get_html_all_content(FULL_URL, "bookinfo", ENCODING)
