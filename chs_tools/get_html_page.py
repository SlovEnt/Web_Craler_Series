...
CHROME_PATH = PARAINFO["CHORME_PATH"]
SAVE_SCREE_FILE = PARAINFO["SAVE_SCREE_FILE"]

chromeOptions = webdriver.ChromeOptions()
chromeOptions.binary_location = PARAINFO["CHORME_PATH"]
chromeDriver = PARAINFO["CHROMEDRIVER_PATH"]
...
def chrome_get_html_all_content(url, pageFlag="", encoding=""):
